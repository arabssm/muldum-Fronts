...
export const IconMenu = [
    ...
    { label: '물품 관리', path: '', icon: icons.object, iconActive: icons.Cobject },
    { label: '월말평가', path: '', icon: icons.check, iconActive: icons.Ccheck },
    { label: '공지사항', path: '', icon: icons.alerticon, iconActive: icons.Calerticon },
    { label: '공지사항', path: '', icon: icons.setting, iconActive: icons.setting }
];