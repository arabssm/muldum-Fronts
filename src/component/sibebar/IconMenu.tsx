...
export const IconMenu = [
    ...
    { label: '역대 동아리', path: ['/club-history'], icon: icons.ranking, iconActive: icons.Cranking },
    // { label: '공유 캘린더', path: '', icon: icons.calender, iconActive: icons.Ccalender },
    { label: '물품 관리', path: ['/object','/object/all'], icon: icons.object, iconActive: icons.Cobject },
    ...
    { label: '팀스페이스', path: ['/teamspace'], icon: icons.Teamspace, iconActive: icons.ATeamspace },
